    ...
    <div class="row justify-content-center">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-9">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        <a class="mb-1 btn btn-primary btn-block" href="{{ route('free-pay') }}" ><i class="fa fa-money"></i> افزایش موجودی</a>
                    </div>
                    <div class="col-md-4">
                        <a class="mb-1 btn btn-warning btn-block" href="{{ route('invoice') }}" ><i class="fa fa-bars"></i> فاکتورها</a>
                    </div>
                    <div class="col-md-4">
                        <a class="mb-1 btn btn-danger btn-block" href="{{ route('ticket.create') }}"><i class="fa fa-plus"></i> ارسال تیکت</a>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="card text-white bg-warning mb-2">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 col-3"><i class="fa fa-calendar-plus-o fa-3x" aria-hidden="true"></i></div>
                                    <div class="col-md-9 col-9">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 mb-2">
                        <item-list-component title="تراکنش ها" web-address="{{ route('dashboard.transactions') }}"></item-list-component>
                    </div>
                    <div class="col-md-6 mb-2">
                        <item-list-component title="فاکتورها" web-address="{{ route('dashboard.invoices') }}"></item-list-component>
                    </div>
                </div>
            </div>
        </div>
