        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('password') }}">تغییر رمز عبور</a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('password') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <small id="current_passwordHelp" class="form-text">لطفا کلمه عبور فعلی که با آن وارد سایت شده اید را بنویسید.</small>
                        ...
                        <div class="form-group">
                            ...
                            <small id="password-confirmHelp" class="form-text">کلمه عبور جدید را با رعایت اصول امینی وارد کنید.</small>
                        ...
                        <div class="form-group">
                            ...
                            <small id="password-confirmHelp" class="form-text">جهت صحت درست وارد شدن کلمه عبور آن را تکرار کنید.</small>
