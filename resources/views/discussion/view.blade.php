        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('discussion.view', ['id' => $discussion->id]) }}">{{ $discussion->title }}</a></li>
                </ol>
            </nav>
                ...
                <div class="col-md-9">
                    <div class="card card-default mb-2">
                        <div class="card-header">
                            ...
                            <span class="badge badge-dark pull-left">{{ jDate::forge($discussion->created_at)->ago() }}</span>
                        </div>
                        <div class="card-body">
                            {!! $discussion->text  !!}
                        </div>
                    ...
                    @auth
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('discussion.post',['id'=>$discussion->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                    ...
                                    <button type="submit" class="btn btn-primary btn-mobile"><i class="fa fa-send"></i>ارسال پاسخ</button>
                                </form>
                            </div>
