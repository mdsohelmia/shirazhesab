        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('transaction.view', ['id'=>$transaction->id]) }}">تراکنش شماره:{{$transaction->id}}</a></li>
                </ol>
            </nav>
        </div>
        <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-8 col-sm-8 text-right" dir="ltr">
                                    {{ jDate::forge($transaction->transaction_at)->format('Y/m/d H:i:s') }}
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-md-4 col-sm-4 col-lg-4 @lang('platform.input-pull')">تاریخ ایجاد:</label>
                                <div class="col-md-8 col-lg-8 col-sm-8 text-right" dir="ltr">
                                    {{ jDate::forge($transaction->created_at)->format('Y/m/d H:i:s') }}
                                </div>
                            </div>
                            <div class="row">
                            ...
                            @if($transaction->invoice_id)
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-sm-8">
                                        <a class="btn btn-sm btn-primary" href="{{ route('invoice.view', ['id' => $transaction->invoice_id]) }}"><i class="fa fa-bars"></i> مشاهده</a>
                                    </div>
                                </div>
                            @endif
