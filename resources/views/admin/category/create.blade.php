            ...
            <div class="col-md-9">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.category.create') }}">ایجاد دسته جدید</a></li>
                    </ol>
                </nav>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.category.insert') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input dir="ltr" id="color" type="text" class="color form-control{{ $errors->has('color') ? ' is-invalid' : '' }}" name="color" value="{{ old('color') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input dir="ltr" id="icon" type="text" class="form-control{{ $errors->has('icon') ? ' is-invalid' : '' }}" name="icon" value="{{ old('icon') }}">
