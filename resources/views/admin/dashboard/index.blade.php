        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-9">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="row justify-content-center">
                            <div class="col-md-12 col-xs-12">
                                <div class="alert alert-info">
                                    ...
                                    امروز {{ jDate::forge('now')->format('l j %B Y')  }}
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-3 col-md-3 col-6">
                                <a class="mb-1 btn btn-primary btn-block" href="{{ route('admin.invoice.create.sale') }}" ><i class="fa fa-plus-circle"></i> فاکتور فروش</a>
                            </div>
                            <div class="col-sm-3 col-md-3 col-6">
                                <a class="mb-1 btn btn-warning btn-block" href="{{ route('admin.invoice.create.purchase') }}" ><i class="fa fa-minus-circle"></i> فاکتور خرید</a>
                            </div>

                            <div class="col-sm-3 col-md-3 col-6">
                                <a class="mb-1 btn btn-success btn-block" href="{{ route('admin.transaction.create.income') }}"><i class="fa fa-arrow-circle-left"></i> ثبت درآمد</a>
                            </div>
                            <div class="col-sm-3 col-md-3 col-6">
                                <a class="mb-1 btn btn-danger btn-block" href="{{ route('admin.transaction.create.expense') }}"><i class="fa fa-arrow-circle-left"></i> ثبت هزینه</a>
                            </div>
                ...
                <div class="row" id="dashboard">
                    <div class="col-md-6 col-sm-6 mb-2">
                        <item-list-component title="تیکت ها" web-address="{{ route('admin.dashboard.tickets') }}"></item-list-component>
                    </div>
                    <div class="col-md-6 col-sm-6 mb-2">
                        <item-list-component title="اخبار نرم افزار شیراز" web-address="{{ route('admin.dashboard.news') }}"></item-list-component>
                    </div>
                </div>
            </div>
        </div>
