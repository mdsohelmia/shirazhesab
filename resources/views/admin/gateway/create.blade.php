@extends('layouts.app')
@section('title', 'ایجاد واسط پرداخت - ')
@section('content')
        ...
        <div class="col-md-9">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ایجاد واسط پرداخت</li>
                </ol>
            </nav>
            <div class="card card-default">
                <div class="card-header">ایجاد واسط پرداخت</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.gateway.insert') }}">
                    @csrf
                    @method('post')
                        ...
                        <div class="form-group">
                            ...
                            <input id="code" dir="ltr" type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" name="code" value="{{ old('code') }}" required>
                            @if ($errors->has('code'))
                                <span class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select name="verity" id="enable" class="form-control">
                                <option value="yes"{{ old('verity') == 'yes'  ? ' selected' : '' }}>بله</option>
                                <option value="no"{{ old('verity') == 'no' ? ' selected' : '' }}>خیر</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input id="payment_password" type="text" dir="ltr" class="form-control{{ $errors->has('payment_password') ? ' is-invalid' : '' }}" name="payment_password" value="{{ old('payment_password') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input id="callback_password" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="callback_password" value="{{ old('callback_password') }}" dir="ltr" required>
                        ...
                        <div class="form-group">
                            ...
                            <input id="website" type="text" class="form-control{{ $errors->has('website') ? ' is-invalid' : '' }}" name="website" value="{{ old('website') }}" dir="ltr">
                        ...
                        <div class="form-group">
                            ...
                            <input id="callback_hook" type="text" class="form-control{{ $errors->has('callback_hook') ? ' is-invalid' : '' }}" name="callback_hook" value="{{ old('callback_hook') }}" dir="ltr">
