                        ...
                        <div class="col-md-3 text-center">
                            ...
                            @else
                                @if($invoice->type == 'sale')
                                    ...
                                    <form action="{{ route('invoice.pay-password',[$invoice->password]) }}" method="post">
                                        @csrf
                                        @method('post')
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.invoice.pay',[$invoice->id])}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="account_id" id="account_id" class="form-control{{ $errors->has('account_id') ? ' is-invalid' : '' }}">
