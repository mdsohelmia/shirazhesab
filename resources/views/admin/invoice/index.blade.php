        ...
        <div class="col-md-9">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.invoice') }}">فاکتورها</a></li>
                </ol>
            </nav>
            <div class="card card-default">
                <div class="card-header">فاکتورها
                    <div class="btn-group pull-left" role="group" aria-label="Basic example">
                        <a href="{{route('admin.invoice.create.purchase')}}" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> فاکتور خرید</a>
                        <a href="{{route('admin.invoice.create.sale')}}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> فاکتور فروش</a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($invoices as $invoice)
                            <tr>
                                ...
                                <td>
                                        <a href="{{ route('admin.invoice.edit', ['id' => $invoice->id]) }}" class="btn btn-sm btn-dark"><i class="fa fa-edit"></i> ویرایش</a>
                                        <a href="{{ route('admin.invoice.view',['id' => $invoice->id]) }}" class="btn btn-sm btn-warning"><i class="fa fa-calculator" aria-hidden="true"></i> مشاهده<a>
                                        <form method="post" action="{{ route('admin.invoice.delete',['id' => $invoice->id]) }}" style="display:inline;">
                                            @csrf
                                            @method('delete')
