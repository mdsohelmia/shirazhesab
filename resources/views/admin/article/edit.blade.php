            ...
            <div class="col-md-9">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.page.edit',['id' => $article->id]) }}">ویرایش مقاله {{ $article->title }}</a></li>
                    </ol>
                </nav>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.article.update',['id' => $article->id]) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="slug" type="text" class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}" name="slug" value="{{ old('slug', $article->slug) }}" required>
                                @if ($errors->has('slug'))
                                    <span class="invalid-feedback">
                            ...
                            <div class="form-group">
                                <label for="description">توضیحات</label>
                                    <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="description"> {{ old('description', $article->description) }}</textarea>
