            ...
            <div class="col-md-9">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.transaction') }}">تراکنش ها</a></li>
                    </ol>
                </nav>
                <div class="card card-default">
                    <div class="card-header">تراکنش ها
                        <div class="btn-group pull-left" role="group" aria-label="Basic example">
                            <a href="{{route('admin.transaction.create.expense')}}" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> ثبت هزینه</a>
                            <a href="{{route('admin.transaction.create.income')}}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> ثبت درآمد</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($transactions as $transaction)
                                <tr>
                                    ...
                                    @endif
                                    <td class="text-center">{{ jDate::forge($transaction->transaction_at)->format('Y/m/d H:i:s') }}</td>
                                    <td class="text-center">
                                    ...
                                    <td>
                                    @if($transaction->amount < 0)
                                        <a href="{{ route('admin.transaction.edit.expense', ['id' => $transaction->id]) }}" class="btn btn-sm btn-dark"><i class="fa fa-edit"></i> ویرایش</a>
                                    @else
                                            <a href="{{ route('admin.transaction.edit.income', ['id' => $transaction->id]) }}" class="btn btn-sm btn-dark"><i class="fa fa-edit"></i> ویرایش</a>
                                    @endif
