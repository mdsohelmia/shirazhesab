    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.transaction.update',['id' => $transaction->id]) }}" onsubmit="$('#amount').unmask();">
                        @csrf
                        @method('post')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-2 ml-sm-2">
                                <input id="amount" type="text" dir="ltr" class="form-control{{ $errors->has('amount',$transaction->amount) ? ' is-invalid' : '' }}" name="amount" value="{{ old('amount',$transaction->amount) }}" required autofocus>
