        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('ticket.create') }}">ایجاد تیکت جدید</a></li>
                </ol>
            </nav>
                            ...
                            <form method="POST" action="{{ route('ticket.insert') }}" enctype="multipart/form-data">
                                ...
                                @if(Auth::user()->level != 'user')
                                    <div class="form-group row">
                                        <label for="user_id" class="col-md-4 col-form-label @lang('platform.input-pull')">مخاطب</label>
                                        <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select id="priority" name="priority" class="form-control{{ $errors->has('priority') ? ' is-invalid' : '' }}">
                                            ...
                                            <option value="not_important"{{old('priority') == 'important' ? ' selected' : ''}}>مهم</option>
                                            <option value="important"{{old('priority') == 'urgent' ? ' selected' : ''}}>ضروری</option>
                                        </select>
