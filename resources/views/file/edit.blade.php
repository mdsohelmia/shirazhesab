            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('file.update',['id'=> $file->id]) }}" enctype="multipart/form-data" onsubmit="$('#price').unmask();">
                                @csrf
                                @method('post')
                                <div class="form-group row">
                                    <label for="title" class="col-md-4 col-form-label @lang('platform.input-pull')">عنوان</label>
                                    <div class="col-md-7">
                                        <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ old('title',$file->title) }}" required autofocus>
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="col-md-7">
                                        <select name="category_id" id="category_id" class="form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }}">
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}"{{old('category_id', $file->category_id) == $category->id ? ' selected' : ''}}>{{$category->title}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <textarea name="description" id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}">{{old('description',$file->description)}}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <textarea name="text" id="text" class="form-control{{ $errors->has('text') ? ' is-invalid' : '' }}">{{old('text',$file->text)}}</textarea>
                                        @if ($errors->has('text'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="source" type="file" class="form-control{{ $errors->has('source') ? ' is-invalid' : '' }}" name="source">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select id="type" name="type" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}">
                                            <option value="paid"{{old('type',$file->type) == 'paid' ? ' selected' : ''}}>تجاری</option>
                                            <option value="free"{{old('type',$file->type) == 'free' ? ' selected' : ''}}>رایگان</option>
                                        </select>
                                        @if ($errors->has('type'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="input-group mb-2 ml-sm-2">
                                            <input id="price" type="text" dir="ltr" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ old('price',$file->price) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select id="published" name="published" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}">
                                            <option value="yes"{{old('published',$file->published) == 'yes' ? ' selected' : ''}}>منتشر شده</option>
                                            <option value="no"{{old('published',$file->published) == 'no' ? ' selected' : ''}}>فایل موقت</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="title" dir="ltr" type="text" class="form-control{{ $errors->has('support_link') ? ' is-invalid' : '' }}" name="support_link" value="{{ old('support_link',$file->support_link) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="title" dir="ltr" type="text" class="form-control{{ $errors->has('learn_link') ? ' is-invalid' : '' }}" name="learn_link" value="{{ old('learn_link',$file->learn_link) }}">
