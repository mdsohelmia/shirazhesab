            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('product') }}">سخت افزار</a></li>
                        <li class="breadcrumb-item" aria-current="page"><a href="{{ route('product.create') }}">افزودن کالا</a></li>
                    </ol>
                </nav>
                <h1>افزودن کال</h1>
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card card-default">
                            <div class="card-header">افزودن کالا</div>

                            <div class="card-body">
                                <form method="POST" action="{{ route('product.insert') }}" enctype="multipart/form-data" onsubmit="$('.price').unmask();">
                                    @csrf
                                    @method('post')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group mb-2 ml-sm-2">
                                                <input id="price" type="text" dir="ltr" class="price form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ old('price') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group mb-2 ml-sm-2">
                                                <input id="off_price" type="text" dir="ltr" class="price form-control{{ $errors->has('off_price') ? ' is-invalid' : '' }}" name="off_price" value="{{ old('off_price') }}">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">تومان</div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <select id="published" name="published" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}">
                                                ...
                                                <option value="no"{{old('published') == 'no' ? ' selected' : ''}}>موقت</option>
                                            </select>
