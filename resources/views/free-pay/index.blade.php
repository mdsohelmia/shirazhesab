                    ...
                    <div class="card-body">
                        ...
                        @guest
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name', session('name')) }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="email" type="email" dir="ltr" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email', session('email')) }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="mobile" type="text" dir="ltr" class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" name="mobile" value="{{ old('mobile', session('mobile')) }}" required>
                        ...
                        @else
                            <input type="hidden" id="user_id" name="user_id" value="{{Auth::user()->id}}">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name',Auth::user()->name) }}" readonly="readonly" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="email" type="email" dir="ltr" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" readonly="readonly" value="{{ old('email',Auth::user()->email) }}" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="mobile" type="text" dir="ltr" class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" readonly="readonly" name="mobile" value="{{ old('mobile',Auth::user()->mobile) }}" required>
                        ...
                        @endguest
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <textarea id="amount" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" required>{{ old('description') }}</textarea>
